...
// const rublesCount = dollarsCount * rublesPerDollar;
...
// 50 TASK
// function getHiddenCard(cardName, stars = 4) {
//   return `${"*".repeat(stars)}${cardName.slice(12)}`;
// }
...
// 57 TASK
// function getLetter(word, countNum) {
//   return word[countNum - 1] || "";
// }

// 58 TASK
// function guessNumber(guest) {
//   return guest == 42 ? "You win!" : "Try again!";
// }
...
//     const nextSymbol = word[i + 1] || "";
//     result = `${result}${nextSymbol}${word[i]}`;
//   }
